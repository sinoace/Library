 ...
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(1.06)、通过解析URL地址获取一个文件名：static String getFileNameFromParseURL(URL url)
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(1.07)、通过解析URL字符串地址获取一个文件名：public static String getFileNameFromURL(String url)
 * <br>
 * <br><b>2、Socket方面</b>
...
public class NetUtils {
	...
	/**
	 * (1.07)、通过解析URL字符串地址获取一个文件名
	 * @param url 网络文件的URL地址字符串
	 * @return 文件的名字
	 */
