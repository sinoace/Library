...
import net.sinoace.library.utils.FileUtils;
import net.sinoace.library.utils.StringUtils;
import net.sinoace.library.utils.StringUtils.StringCheckUpWayEnum;
...
public class FileScanner {
	 ...
	 * 文件类别过滤方式，默认方式为包含标记
	 */
	private StringCheckUpWayEnum fileTypeFilterWay = StringCheckUpWayEnum.CONTAIN_KEYWORDS;
	
	/**
	 * 文件名过滤方式，默认方式为包含标记
	 */
	private StringCheckUpWayEnum fileNameFilterWay = StringCheckUpWayEnum.CONTAIN_KEYWORDS;
	/**
	 * 文件路径过滤方式，默认不等于
	 */
	...
	public void clearAllSetting(File rootDir) throws NullPointerException, FileNotFoundException, IllegalArgumentException{
		...
		setFileTypeFilterWay(StringCheckUpWayEnum.CONTAIN_KEYWORDS);
		setFileNameFilterWay(StringCheckUpWayEnum.CONTAIN_KEYWORDS);
		setNeedResatrtCreateExtendFileFilter(true);
		finalFileFilter = null;
	}
	 ...
	 * @return 文件类别过滤方式
	 */
	public StringCheckUpWayEnum getFileTypeFilterWay() {
	 ...
	 */
	public void setFileTypeFilterWay(StringCheckUpWayEnum fileTypeFilterWay) {
	 ...
	 * @return 文件名过滤方式
	 */
	public StringCheckUpWayEnum getFileNameFilterWay() {
	 ...
	 */
	public void setFileNameFilterWay(StringCheckUpWayEnum fileNameFilterWay) {
