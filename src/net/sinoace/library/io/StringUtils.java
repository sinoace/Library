...
public class StringUtils {
	...
	/**
	 * 判断给定的字符串是否不为null并且不为空
	 * @param string 给定的字符串
	 * @return 是否不为null并且不为空
	 */
	 ...
	 * @return 是否符合要求
	 */
	public static boolean checkUp(String string, List<String> listKeywords, StringCheckUpWayEnum checkUpWay){
		boolean result = false;
		if(checkUpWay == StringCheckUpWayEnum.CONTAIN_KEYWORDS){
		...
		}else if(checkUpWay == StringCheckUpWayEnum.NOT_CONTAIN_KEYWORDS){
			result = !checkUp(string, listKeywords, StringCheckUpWayEnum.CONTAIN_KEYWORDS);
		}else if(checkUpWay == StringCheckUpWayEnum.EQUAL_KEYWORDS){
			for(String flag : listKeywords){
		...
		}else if(checkUpWay == StringCheckUpWayEnum.NOT_EQUAL_KEYWORDS){
			result = !checkUp(string, listKeywords, StringCheckUpWayEnum.EQUAL_KEYWORDS);
		}else if(checkUpWay == StringCheckUpWayEnum.ENDS_WITH_KEYWORDS){
			for(String flag : listKeywords){
		...
		}else if(checkUpWay == StringCheckUpWayEnum.NOT_ENDS_WITH_KEYWORDS){
			result = !checkUp(string, listKeywords, StringCheckUpWayEnum.ENDS_WITH_KEYWORDS);
		}else if(checkUpWay == StringCheckUpWayEnum.STARTS_WIT_KEYWORDS){
			for(String flag : listKeywords){
		...
		}else if(checkUpWay == StringCheckUpWayEnum.NOT_STARTS_WIT_KEYWORDS){
			result = !checkUp(string, listKeywords, StringCheckUpWayEnum.STARTS_WIT_KEYWORDS);
		}
		return result;
	}
	 ...
	 *
	 */
	public enum StringCheckUpWayEnum {
		/**
		 * 包含标记
		 */
		CONTAIN_KEYWORDS,
